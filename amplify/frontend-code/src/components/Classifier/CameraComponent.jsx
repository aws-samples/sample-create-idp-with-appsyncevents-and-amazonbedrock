...
const CameraComponent = (props) => {
  ...
  const uploadPicture = async () => {
    ...
    await props.uploadDocument(`documents/camera-${uuid}.jpeg`, croppedImage, true)
    resetState();
  }
  ...
  return (
    <>
      ...
      <div className="classifierImageFormArea">
        <button type="button" ref={refs.setReference} onClick={startWebcam} className="cameraButton"/>
      </div>
      <>
                ...
                { imageOn && !videoOn ? (
                  <>
                    ...
                    <div id="cameraBtnListCanvas" className="cameraBtnListCanvasArea">
                      <Button color="white" borderColor={"purple"} backgroundColor={"purple"} onClick={uploadPicture} size="small">
                        Upload
                      </Button>
